...
namespace Rockaway.WebApp.Migrations
{
    ...
    [Migration("20240826102448_InitialCreate")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a3d73c3e-0041-4d74-8dd1-7ed9110c5648",
                            Email = "admin@rockaway.dev",
                            EmailConfirmed = true,
                            LockoutEnabled = true,
                            NormalizedEmail = "ADMIN@ROCKAWAY.DEV",
                            NormalizedUserName = "ADMIN@ROCKAWAY.DEV",
                            PasswordHash = "AQAAAAIAAYagAAAAEPwT7fwjOsUd2Mwby22AIGPUW9FxgzpclcuUdyUem/5xldOFhtXjKFC3DSO8pv3OqA==",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "c120cd4a-daed-40bd-a5f1-6517d2bad5c7",
            ...
            modelBuilder.Entity("Rockaway.WebApp.Data.Entities.SupportSlot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ShowDate = new DateOnly(2024, 8, 27),
                            SlotNumber = 1,
                        ...
                        new
                        {
                            ...
                            ShowDate = new DateOnly(2024, 8, 28),
                            SlotNumber = 1,
                            ArtistId = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaa11")
                        },
                        new
                        ...
                        new
                        {
                            ...
                            ShowDate = new DateOnly(2024, 8, 29),
                            SlotNumber = 1,
                            ArtistId = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaa11")
                        },
                        new
                        ...
                        new
                        {
                            ...
                            ShowDate = new DateOnly(2024, 8, 30),
                            SlotNumber = 1,
                            ArtistId = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaa10")
                        },
                        new
                        {
                            ...
                            ShowDate = new DateOnly(2024, 8, 31),
                            SlotNumber = 1,
                            ArtistId = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaa10")
                        },
                        new
                        {
                            ...
                            ShowDate = new DateOnly(2024, 9, 1),
                            SlotNumber = 1,
                            ArtistId = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaa10")
                        },
                        new
                        {
                            ...
                            ShowDate = new DateOnly(2024, 9, 2),
                            SlotNumber = 1,
                            ArtistId = new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaa10")
                        },
                        new
            ...
            modelBuilder.Entity("Rockaway.WebApp.Data.Entities.TicketOrder", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompletedAt = new DateTimeOffset(new DateTime(2024, 7, 16, 9, 37, 16, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 7, 16, 9, 4, 16, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CompletedAt = new DateTimeOffset(new DateTime(2024, 7, 19, 13, 40, 18, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 7, 19, 13, 4, 18, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CompletedAt = new DateTimeOffset(new DateTime(2024, 7, 21, 10, 35, 12, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 7, 21, 10, 4, 12, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
